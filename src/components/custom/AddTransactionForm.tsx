                ...
                >
                  <FormItem>
                    ...
                    <Label
                      htmlFor="income"
                      className={cn(
                        "flex items-center justify-center rounded-md border-2 border-muted bg-popover p-3 font-medium hover:bg-accent hover:text-accent-foreground cursor-pointer",
                        field.value === "INCOME" &&
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="Ăn tối, mua sắm..." {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
